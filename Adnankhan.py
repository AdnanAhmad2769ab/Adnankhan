...
os.system('xdg-open https://www.facebook.com/AdnanAhmad2769A?mibextid=ZbWKwL/')
...
╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═══╝
----------------------------------------------
 Author    : Adnan Ahmad village Gomal Pakhtoon 
 Github    : AdnanAhmad2769ab
 Facebook  : MR.Adnan Ahmad
what's app: +923456497614
 Tool Name : Adnan-PRO
 Type type : Darta free me krai 
 Version   : 1.9.8
----------------------------------------------
 Adnan Pro version 1.9.8
 For Haters: Yarano jaaan Taa subha Yam Gomal King Adnan Ahmad  🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923456497614&text="
